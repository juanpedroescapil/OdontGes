class CategoriaController < ApplicationController
  ...
  # GET /categoria/new
  def new
    @categoria = current_user.categoria.new
  end

  # GET /categoria/1/edit
  def edit
    @categoria = current_user.categoria.find(params[:id])
  end

  # POST /categoria
  # POST /categoria.json
  def create
    @categoria = current_user.categoria.new(categoria_params)
  ...
  private
    ...
    def categoria_params
      params.require(:categorium).permit(:title, :user_id)
    end
end