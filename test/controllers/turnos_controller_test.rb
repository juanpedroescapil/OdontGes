...
class TurnosControllerTest < ActionController::TestCase
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post :create, turno: { dia: @turno.dia, hora: @turno.hora, id_paciente: @turno.id_paciente, id_usuario: @turno.id_usuario }
    end
  ...
  test "should update turno" do
    patch :update, id: @turno, turno: { dia: @turno.dia, hora: @turno.hora, id_paciente: @turno.id_paciente, id_usuario: @turno.id_usuario }
    assert_redirected_to turno_path(assigns(:turno))
  end
